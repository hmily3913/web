...
<%
if Instr(session("AdminPurviewFLW"),"|1102,")=0 then 
...
var rMenu;
	setting = {
		...
		asyncParamOther : {"showType":"getInfo","detailType":"SetPurview","PurviewType":"FLW","EmpId":"<%=ID%>"},
		callback: {
	...
	function refreshTree() {
		...
		var nodes = [];
		setting.async = true;
		zTree1 = $("#PermissionFLW").zTree(setting, nodes);
	}
...
<table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#99BBE8">
  ...
  <tr>
    <td height="24" align="center" nowrap  bgcolor="#EBF2F9"><a >添加管理员</a><font color="#0000FF">&nbsp;|&nbsp;</font><a href="FLW_PurviewSet.asp" onClick='changeAdminFlag("网站管理员")'>查看所有员工</a></td>    
  </tr>
</table>
<br>
<table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#99BBE8">
  <form name="editForm" method="post" action="FLW_PurviewEdit.asp?Action=SaveEdit&Result=<%=Result%>&ID=<%=ID%>">
  <tr>
      ...
      <tr >
        ...
        <td nowrap>
  		<div class="zTreeDemoBackground">
			<ul id="PermissionFLW" class="tree"></ul>
		</div>		
	  </td>
