    ...
    $.addFlex = function(t, p) {
                ...
                if (p.dataType == 'json') {
                    ...
                    function(i, row) {
                        ...
                        if (i % 2 && p.striped) {
												...
												if (p.rowbinddata) {
														tbhtml.push("ch='", row.cell.join("_ZZ$BH_"), "'");
												}
												tbhtml.push(">");
												var trid = row.id;
            ...
            addRowProp: function() {
                ...
                $('tbody tr', g.bDiv).each(function() {
                    ...
                    $(this).dblclick(function(e) {
                        ...
                        $.each($(this).find('div'), 
                        function(i) {
													if(!p.showcheckbox||i!=0)
                            $(rowData).data(p.colModel[(p.showcheckbox?(i-1):i)].name, $(this).text());
                        });
                        ...
                        $(this).toggleClass('trSelected');
												if(p.showcheckbox){
													if($(this).hasClass('trSelected'))
														$("input.itemchk", this).attr("checked", true);
													else
														$("input.itemchk", this).attr("checked", false);
												}
                        lastSelected = this;
                        ...
                        if (e.shiftKey) {
                            ...
                            if (!p.singleSelect) {
                                ...
                                for (var i = start; i < end; i++) {
                                    if (tableRows[i].className.search('trSelected') < 0){
																			$(tableRows[i]).toggleClass('trSelected');
																			if(p.showcheckbox)$("input.itemchk", tableRows[i]).attr("checked", true);
																		}
                                }
                            }
                        }
        ...
        if (p.colModel) {
            ...
            if (p.showcheckbox) {
                ...
                cth.addClass("cth").attr({ 'axis': "col-1", width: "18", "isch": true,toggle:false }).append(cthch);
                $(tr).append(cth);
            }
